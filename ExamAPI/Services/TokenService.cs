...
namespace ExamAPI.Services
{
    public class TokenService : ITokenService
    {
        ...
        public string GenerateJwtToken(string userAccount, string role)
        {
             ...
             */
            _logger.LogInformation("產生JWT Token成功，UserAccount：{userAccount}，到期時間：{Expire}", userAccount, DateTime.UtcNow.AddMinutes(Convert.ToDouble(jwtSettings["ExpireMinutes"])).ToLocalTime());
